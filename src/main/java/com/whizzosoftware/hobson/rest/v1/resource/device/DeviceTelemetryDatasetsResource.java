...
import com.whizzosoftware.hobson.dto.TemporalValueDTO;
...
public class DeviceTelemetryDatasetsResource extends SelfInjectingServerResource {
    ...
    /**
     * @api {get} /api/v1/users/:userId/hubs/:hubId/plugins/:pluginId/devices/:deviceId/telemetry/datasets Get device variable telemetry datasets
     * @apiVersion 0.5.0
     * @apiName GetDeviceTelemetryDatasets
     * @apiDescription Retrieves telemetry datasets for a specific device.
     * @apiGroup Devices
    ...
    protected Representation get() {
        ...
        for (String var : vars) {
            ...
            TelemetryDatasetDTO.Builder builder = new TelemetryDatasetDTO.Builder(linkHelper.createDeviceTelemetryDatasetLink(dctx, var));
            builder.name(var);
        ...
        return new JsonRepresentation(datasets.toJSON(linkHelper));
    }
}
